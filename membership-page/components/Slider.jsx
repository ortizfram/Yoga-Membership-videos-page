...
function Slider() {
  ...
  return (
    // container
    <div className="mt-[-150px] 2xl:mt-[160px] md:grid lg:max-h-[600px] h-[40vh] w-[60vw]  md:max-w-[700px] 2xl:max-h-[900px] 2xl:h-[60vh] 2xl:max-w-[700px] 2xl:mr-[170px] m-auto relative group shadow-2xl  xl:px-8">
      <div
        // link imgs
